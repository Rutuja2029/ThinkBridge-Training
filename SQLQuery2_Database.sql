...
Select * from AGENTS where AGENT_CODE in( Select AGENT_CODE from CUSTOMER where CUSTOMER.CUST_NAME='Karolina')

Select * from AGENTS where AGENT_CODE in( Select AGENT_CODE from CUSTOMER where CUSTOMER.CUST_CITY='Torento')
--------------------------------------------------------------------------------------------------------------
--Same output--
Select AGENTS.AGENT_CODE, AGENTS.AGENT_NAME from AGENTS where AGENT_CODE 
in( Select AGENT_CODE from CUSTOMER where CUSTOMER.CUST_COUNTRY='India')

Select Distinct(AGENTS.AGENT_CODE), AGENTS.AGENT_NAME from AGENTS
Inner join CUSTOMER 
